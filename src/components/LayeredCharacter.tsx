...
const HAIRSTYLE_POSITIONS: Record<string, string> = {
  ...
  style4: 'translate(-4, -18)',
  style5: 'translate(29, -18)',
  style6: 'translate(1, -18)',
  style7: 'translate(-1, -15)',
...
const LayeredCharacter = forwardRef<LayeredCharacterRef, LayeredCharacterProps>(({
  ...
  const renderComposite = () => {
    ...
    if (hairSVG) {
      const hairPaths = hairSVG.querySelectorAll('path[fill="#262424"], path[fill="#AC7ED3"]');
