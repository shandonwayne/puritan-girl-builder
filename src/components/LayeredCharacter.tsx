...
import dress1SVG from '../assets/apron_style.svg';
import dress2SVG from '../assets/classic.svg';
import dress3SVG from '../assets/collared.svg';
import dress4SVG from '../assets/laced_bodice.svg';
import dress5SVG from '../assets/ruffled.svg';
import dress6SVG from '../assets/simple_bodice.svg';
...
export default function LayeredCharacter({
  ...
  const renderComposite = () => {
    ...
    if (hairSVG) {
      ...
      hairGroup.setAttribute('transform', 'translate(27.5, -10)');
