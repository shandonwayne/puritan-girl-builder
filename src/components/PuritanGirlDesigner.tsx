...
import hairstyle1SVG from '../assets/hairstyle-1 copy.svg';
import hairstyle1SelectedSVG from '../assets/hairstyle-1 copy.svg';
import hairstyle2SVG from '../assets/hairstyle-2 copy copy.svg';
import hairstyle2SelectedSVG from '../assets/hairstyle-2 copy copy.svg';
import hairstyle3SVG from '../assets/hairstyle-3 copy.svg';
import hairstyle3SelectedSVG from '../assets/hairstyle-3 copy.svg';
import hairstyle4SVG from '../assets/hairstyle-4 copy.svg';
import hairstyle4SelectedSVG from '../assets/hairstyle-4 copy.svg';
import hairstyle5SVG from '../assets/hairstyle-5 copy.svg';
import hairstyle5SelectedSVG from '../assets/hairstyle-5 copy.svg';
import hairstyle6SVG from '../assets/hairstyle-6 copy.svg';
import hairstyle6SelectedSVG from '../assets/hairstyle-6 copy.svg';
import hairstyle7SVG from '../assets/hairstyle-7 copy.svg';
import hairstyle7SelectedSVG from '../assets/hairstyle-7 copy.svg';
import hairstyle8SVG from '../assets/hairstyle-8 copy.svg';
import hairstyle8SelectedSVG from '../assets/hairstyle-8 copy.svg';
...
const SKIN_TONES = [
  ...
  { id: 'tan', name: 'Tan', color: '#A87A5E' },
  { id: 'deep', name: 'Deep', color: '#8B6347' },
          ...
          <div className="relative py-5 px-3 rounded-2xl overflow-hidden" style={{ backgroundColor: '#D8C3E6' }}>
            ...
            <div className="flex items-center justify-center overflow-visible" style={{ height: '150px' }}>
              <button
                ...
                style={{ width: '250px', height: '150px', marginLeft: 'auto', marginRight: 'auto' }}
              >
                <div
                    ...
                    <img
                      ...
                      style={{
                        ...
                        filter: currentDesign.dress_style === dress.id
                          ? 'brightness(0) saturate(100%) invert(55%) sepia(14%) saturate(460%) hue-rotate(215deg) brightness(88%) contrast(90%)'
                          : 'none'
                      }}
                    />
                  </div>
